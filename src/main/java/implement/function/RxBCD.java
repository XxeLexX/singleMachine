...
public abstract class RxBCD {
    ...
    protected Observable<Quartet<Integer, Long, Long, Integer>> calculateDegreeAndCollect(int vertexId, TreeMap<Long, Integer> degreeTree, Long vertexFromTime, Long vertexToTime) {
        ...
        return Observable.fromStream(tuple4Builder.build());
